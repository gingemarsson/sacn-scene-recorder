...
export const readScenes = async (): Promise<SceneData[]> =>
    (
        await knex('scene').select({
            ...
            sinusWaveScale: 'sinusWaveScale',
            sinusWavePeriod: 'sinusWavePeriod',
            sinusWaveOffset: 'sinusWaveOffset',
            sortIndex: 'sortIndex',
            enabled: 'enabled',
            dmxData: 'dmxData',
            useMaster: 'useMaster',
        ...
        return {
            ...
            sinusWaveScale: scene.sinusWaveScale,
            sinusWavePeriod: scene.sinusWavePeriod,
            sinusWaveOffset: scene.sinusWaveOffset,
